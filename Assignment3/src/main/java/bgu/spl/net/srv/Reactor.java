...
//mvn exec:java - Dexec.mainClass="bgu.spl.net.impl.BGSServer.ReactorMain” - Dexec.args=”127.0.0.1 4"
    public Reactor(
            int numThreads,
            int port,
    ...
    /*package*/ void updateInterestedOps(SocketChannel chan, int ops) {
        ...
        if (Thread.currentThread() == selectorThread) {
            ...
            selectorTasks.add(() -> {
//                System.out.println("received " + ops);
                key.interestOps(ops);
            });
            selector.wakeup();
        }
    ...
    private void handleAccept(ServerSocketChannel serverChan, Selector selector) throws IOException {
        ...
        final NonBlockingConnectionHandler<T> handler = new NonBlockingConnectionHandler<T>(
                ...
                this,
                counterID);
        ConnectionsImpl.getInstance().addToCon(counterID, handler);
        counterID++;
